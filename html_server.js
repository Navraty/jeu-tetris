function start_html_server() {
  ...
  const server = http.createServer(function(request, response) {
    ...
    response.end();
      ...
      console.log("Server (DoCode) running at http://akafack.docode.qwasar.io");
      // console.log("Replace XXXXXXXXX by your current workspace ID");
      // console.log("(look at the URL of this page and akafack_s.docode.qwasar.io, XXXXXXXXX is your workspace ID)");
  });
}
